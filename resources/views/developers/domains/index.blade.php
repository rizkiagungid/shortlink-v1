...
@section('content')
    <div class="bg-base-1 flex-fill">
        <div class="container h-100 py-3 my-3">
            ...
            <h1 class="h2 mb-0 d-inline-block">{{ __('Domains') }}</h1>
...
<div class="bg-dark text-light p-3 rounded d-flex align-items-center mb-3" dir="ltr">
    ...
    <pre class="m-0 text-light">{{ route('api.domains.index') }}</pre>
</div>
...
<div class="bg-dark text-light p-3 rounded d-flex align-items-center mb-3" dir="ltr">
<span class="badge bg-light text-success px-2 py-1 mr-3">GET</span>
<pre class="m-0 text-light">{!! str_replace(':id', '<span class="text-success">{id}</span>', route('api.domains.show', ['id' => ':id'])) !!}</pre>
</div>
...
<pre class="bg-dark text-light p-3 mb-0 rounded text-left" dir="ltr">
curl --location --request GET '{!! str_replace(':id', '<span class="text-success">{id}</span>', route('api.domains.show', ['id' => ':id'])) !!}' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer <span class="text-success">{api_key}</span>'
</pre>
                </div>
...
<pre class="m-0 text-light">{{ route('api.domains.store') }}</pre>
</div>
                    <p class="mb-1">
                        {{ __('Request example') }}:
                    </p>
...
--data-urlencode 'name=<span class="text-success">{name}</span>'
                    ...
                    @include('developers.domains.store-update', ['type' => 1])
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="bg-dark text-light p-3 rounded d-flex align-items-center mb-3" dir="ltr">
                        ...
                        <pre class="m-0 text-light">{!! str_replace(':id', '<span class="text-success">{id}</span>', route('api.domains.update', ['id' => ':id'])) !!}</pre>
                    </div>
                    ...
                    <pre class="bg-dark text-light p-3 rounded text-left" dir="ltr">
curl --location --request PUT '{!! str_replace(':id', '<span class="text-success">{id}</span>', route('api.domains.update', ['id' => ':id'])) !!}' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--header 'Authorization: Bearer <span class="text-success">{api_key}</span>'
</pre>

                    @include('developers.domains.store-update', ['type' => 0])
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="bg-dark text-light p-3 rounded d-flex align-items-center mb-3" dir="ltr">
                        ...
                        <pre class="m-0 text-light">{!! str_replace(':id', '<span class="text-success">{id}</span>', route('api.domains.destroy', ['id' => ':id'])) !!}</pre>
                    </div>
                    ...
                    <pre class="bg-dark text-light p-3 mb-0 rounded text-left" dir="ltr">
curl --location --request DELETE '{!! str_replace(':id', '<span class="text-success">{id}</span>', route('api.domains.destroy', ['id' => ':id'])) !!}' \
--header 'Authorization: Bearer <span class="text-success">{api_key}</span>'
</pre>
                </div>
            </div>
