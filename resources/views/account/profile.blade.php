    ...
    <div class="row m-n2">
        @php
            $menu = [
                ...
                ['icon' => 'icons.workspaces', 'route' => 'admin.spaces', 'title' => __('Spaces'), 'stats' => 'spaces'],
                ['icon' => 'icons.website', 'route' => 'admin.domains', 'title' => __('Domains'), 'stats' => 'domains'],
                ['icon' => 'icons.filter-center-focus', 'route' => 'admin.pixels', 'title' => __('Pixels'), 'stats' => 'pixels']
            ];
        @endphp
