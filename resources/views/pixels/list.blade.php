                        ...
                        <div class="row align-items-center">
                            <div class="col text-truncate">
                                <div class="row align-items-center">
                                    ...
                                    <div class="d-none d-lg-block col-lg-2">
                                        <div class="text-truncate" data-tooltip="true" title="{{ $pixel->created_at->tz(Auth::user()->timezone ?? config('app.timezone'))->format(__('Y-m-d') . ' H:i:s') }}">{{ $pixel->created_at->diffForHumans() }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto">
